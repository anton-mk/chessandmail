...
//добавляет ссылку сделать ход
//------------------------------------------------------------------------------------
  this.add_link_make_move =function(select_piece){
    var i=this.c_ins_link_make_move;
    var tr;
    var td;
    var s;

    this.row_operation_make_move =i;
    this.count_row_operation_make_move =0;
    if (!select_piece){
        tr =document.getElementById("operations_").insertRow(i++); this.count_row_operation_make_move++;
        td =document.createElement("td");
        td.setAttribute("height","25");
        td.setAttribute("valign","top");
        td.setAttribute("class","left_");
        td.innerHTML ='<IMG onclick="o_game_.onMakeMove(\'\');" src="Image/label_move.png" width="181" height="23" border="0" style="border:none; vertical-align: top; cursor:pointer">';
        tr.appendChild(td);
        td =document.createElement("td");
        td.setAttribute("colspan","2");
        td.setAttribute("valign","top");
        td.innerHTML ='<IMG onclick="o_game_.onMakeMove(\'\');" src="Image/button.jpg" width="24" height="25" border="0" style="border:none; vertical-align: top; cursor:pointer">';
        tr.appendChild(td);
        tr =document.getElementById("operations_").insertRow(i++); this.count_row_operation_make_move++;
        td =document.createElement("td");
        ...
        for (var j=1; j <=4; j++){
            ...
            td.setAttribute("class","left_");
            switch(j){
                case 1 : td.innerHTML ='<IMG onclick="o_game_.onMakeMove(\'q\');" src="Image/Choose_' + this.color_ + 'q.png" width="181" height="23" border="0" style="border:none; vertical-align: top; cursor:pointer">';
                         s ='<IMG onclick="o_game_.onMakeMove(\'q\');" src="Image/button.jpg" width="24" height="25" border="0" style="border:none; vertical-align: top; cursor:pointer">';
                         break;
                case 2 : td.innerHTML ='<IMG onclick="o_game_.onMakeMove(\'r\');" src="Image/Choose_' + this.color_ + 'r.png" width="181" height="23" border="0" style="border:none; vertical-align: top; cursor:pointer">';
                         s ='<IMG onclick="o_game_.onMakeMove(\'r\');" src="Image/button.jpg" width="24" height="25" border="0" style="border:none; vertical-align: top; cursor:pointer">';
                         break;
                case 3 : td.innerHTML ='<IMG onclick="o_game_.onMakeMove(\'b\');" src="Image/Choose_' + this.color_ + 'b.png" width="181" height="23" border="0" style="border:none; vertical-align: top; cursor:pointer">';
                         s ='<IMG onclick="o_game_.onMakeMove(\'b\');" src="Image/button.jpg" width="24" height="25" border="0" style="border:none; vertical-align: top; cursor:pointer">';
                         break;
                case 4 : td.innerHTML ='<IMG onclick="o_game_.onMakeMove(\'n\');" src="Image/Choose_' + this.color_ + 'n.png" width="181" height="23" border="0" style="border:none; vertical-align: top; cursor:pointer">';
                         s ='<IMG onclick="o_game_.onMakeMove(\'n\');" src="Image/button.jpg" width="24" height="25" border="0" style="border:none; vertical-align: top; cursor:pointer">';
                         break;
            }//switch
            tr.appendChild(td);
            td =document.createElement("td");
    ...
    if (this.row_operation_drawn !=-1) this.row_operation_drawn +=this.count_row_operation_make_move;
    if (this.row_operation_accept_drawn !=-1) this.row_operation_accept_drawn +=this.count_row_operation_make_move;
    if (this.row_in_variant !=-1) this.row_in_variant +=this.count_row_operation_make_move;
  }//add_link_make_move
//------------------------------------------------------------------------------------

//удаляет ссылки "сделать ход" и "выбрать фигуру"
//------------------------------------------------------------------------------------
  this.del_link_make_move =function(){
    for (var i=1; i <=this.count_row_operation_make_move; i++)
      document.getElementById("operations_").deleteRow(this.row_operation_make_move);

    if (this.row_operation_drawn !=-1) this.row_operation_drawn -=this.count_row_operation_make_move;
    if (this.row_operation_accept_drawn !=-1) this.row_operation_accept_drawn -=this.count_row_operation_make_move;
    if (this.row_in_variant !=-1) this.row_in_variant -=this.count_row_operation_make_move;

    this.row_operation_make_move =-1;
    this.count_row_operation_make_move =0;
...
//           alert(o_result_.text_error_);
             if (o_result_.text_error_ ==='move_access'){
               ...
               document.getElementById(this.sel_cell2_).src =this.lib_images[this.image_cell_(this.sel_cell2_.charAt(0),this.sel_cell2_.charAt(1),true)].src;
               if (((this.color_=='b') && (this.sel_cell2_.charAt(1) == 1) &&
                    (this.board_[this.sel_cell1_.charAt(0)][this.sel_cell1_.charAt(1)] == 'bp')) ||
                   ((this.color_=='w') && (this.sel_cell2_.charAt(1) == 8) &&
                    (this.board_[this.sel_cell1_.charAt(0)][this.sel_cell1_.charAt(1)] == 'wp')))
                  this.add_link_make_move(true);
                else
                  this.add_link_make_move(false);
             }
           }catch(e){
//             alert(this.o_xmlhttp_status_.responseText);
           }
          ...
          this.read_status();
        }else if ((c1 !='') && (c2 !='') && (c2 != cell_) && (c1 != cell_)){
          document.getElementById(c1).src =this.lib_images[this.image_cell_(c1.charAt(0),c1.charAt(1),false)].src;
          this.sel_cell1_ ='';
          document.getElementById(c2).src =this.lib_images[this.image_cell_(c2.charAt(0),c2.charAt(1),false)].src;
          this.sel_cell2_ ='';
          if ((this.board_[cell_.charAt(0)][cell_.charAt(1)] !='') &&
              (this.board_[cell_.charAt(0)][cell_.charAt(1)].charAt(0) ==this.color_)){
            document.getElementById(cell_).src =this.lib_images[this.image_cell_(cell_.charAt(0),cell_.charAt(1),true)].src;
...
//Обработчик ссылки совершить ход
//---------------------------------------------------------------------------------------------------------
  this.onMakeMove =function(piece_){
    if (this.o_timer_status_){
      clearTimeout(this.o_timer_status_);
      this.o_timer_status_ =null;
    }
    ...
    q_.num_last_move =this.table_moves_.length;
    q_.num_game_ =this.num_game_;
    q_.cell_1 = this.sel_cell1_;
    q_.cell_2 = this.sel_cell2_;
    q_.piece_ =piece_;
    this.o_xmlhttp_status_.open("post","ajax_game.php",false);
    this.o_xmlhttp_status_.send(JSON.stringify(q_));
    if (this.o_xmlhttp_status_.status ==200){
